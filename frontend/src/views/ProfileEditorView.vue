...
<template>
  ...
  <form v-if="!loading" class="editor-layout" @submit.prevent="save(false)">
    <nav class="editor-nav" aria-label="Profilbereiche"><a href="#general">Allgemein</a><a href="#matching">Event-Matching</a><a href="#placement">Platzierung</a><a href="#schedule">Zeitplan</a></nav>
